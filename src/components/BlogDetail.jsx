...
const BlogDetail = () => {
  ...
  useEffect(() => {
    ...
    // Check native share support after mount
  ...
  const btnDefault = "border-slate-700 bg-[#030610] text-slate-400 hover:text-white hover:border-slate-500/60 hover:bg-slate-500/10 hover:shadow-[2px_2px_0_0_rgba(100,116,139,0.3)]";
  ...
  const shareButtons = [
    {
      ...
      hoverClass: 'hover:text-green-400 hover:border-green-500/60 hover:bg-green-500/10',
      icon: (
    ...
    },
    {
      ...
      hoverClass: 'hover:text-white hover:border-slate-500/60 hover:bg-slate-500/10',
      icon: (
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      hoverClass: 'hover:text-blue-400 hover:border-blue-500/60 hover:bg-blue-500/10',
      icon: (
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      hoverClass: 'hover:text-sky-400 hover:border-sky-500/60 hover:bg-sky-500/10',
      icon: (
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="font-mono max-w-4xl mx-auto py-10 animate-in fade-in duration-500">
      ...
      <div className="mb-10 border border-slate-800 bg-[#030610] p-4 relative">
        ...
        {/* Share buttons grid — 3 columns on mobile, flex row on desktop */}
        <div className="grid grid-cols-3 gap-2 sm:flex sm:flex-wrap sm:gap-3">
          {shareButtons.map((btn) => (
            <button
              ...
              onClick={btn.onClick}
              title={btn.label}
              className={`${btnBase} border-slate-700 bg-[#030610] text-slate-400 ${btn.hoverClass} hover:shadow-[2px_2px_0_0_rgba(100,116,139,0.3)]`}
            >
              {btn.icon}
              <span className="text-[9px] sm:text-[10px]">{btn.label}</span>
            </button>
          ))}
          ...
          <button
            ...
            className={`${btnBase} ${copied
                ? 'border-primary/60 bg-primary/10 text-primary shadow-[2px_2px_0_0_rgba(78,222,163,0.3)]'
                : 'border-slate-700 bg-[#030610] text-slate-400 hover:text-primary hover:border-primary/60 hover:bg-primary/10 hover:shadow-[2px_2px_0_0_rgba(78,222,163,0.3)]'
              }`}
          >
        ...
        {/* Native Share button — always visible on supported devices */}
        {canNativeShare && (
          <button
            onClick={nativeShare}
            className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-primary/40 bg-primary/5 text-primary text-[10px] font-bold uppercase tracking-widest transition-all duration-200 hover:bg-primary/15 hover:border-primary/60 hover:shadow-[2px_2px_0_0_rgba(78,222,163,0.3)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
          >
